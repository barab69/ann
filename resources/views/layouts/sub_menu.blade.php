...
@php($sectionName = (Request::get('section') === null) ? 'general' : Request::get('section'))
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (Request::is('settings*')) ? '' : 'd-none' }}"
     id="#kt_header_menu" data-kt-menu="true">
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('front-settings*','notice-boards*','testimonials*')) ? 'd-none' : '' }}" id="#kt_header_menu" data-kt-menu="true">
    @role('Admin')
