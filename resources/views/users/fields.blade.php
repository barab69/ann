    ...
    <div class="col-lg-6">
        ...
        @if(!$isEdit)
            <div class="mb-5">
                ...
                {{ Form::select('department_id', $role, null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'role', 'placeholder' => 'Select Role', 'tabindex' => '4', 'data-control' => 'select2']) }}
            </div>
        @endif
