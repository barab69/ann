...
mix.sass('resources/assets/sass/bootstrap.scss',
    'public/assets/css/bootstrap.css').sass('resources/assets/sass/infy-loader.scss',
    'public/assets/css/infy-loader.css').sass('resources/assets/sass/custom.scss', 'public/assets/css/custom.css').sass('resources/assets/sass/home_custom.scss',
    'public/assets/css/home_custom.css').sass('resources/assets/sass/sub-header.scss',
    'public/assets/css/sub-header.css').sass('resources/assets/sass/detail-header.scss',
...
mix.js('resources/assets/js/custom/custom.js',
    ...
    'public/assets/js/payments/create-edit.js').js('resources/assets/js/invoices/invoice.js',
